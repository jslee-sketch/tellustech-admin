...
- **v2.9.5 · 2026-05-04**: Inventory 3-screen enrichment — options/avg-price/available-qty/situation columns. DB migration (PurchaseItem.options + InventoryItem.options). Single-S/N detail card on tx list.
- **v2.9.4 · 2026-05-04**: Inventory transaction form reorganized — S/N first + master status validation + 7 policies (A/B/D/E/G/H + server-side S/N-item match). Lines default empty, S/N→item auto-mapping lock, archived resurrect, external-archived OUT blocked, inbound warehouse fallback. Full details in Appendix K.
- **v2.9.3 · 2026-05-04**: Inventory OUT toWarehouse field + QR label master validation + orphan S/N backfill (123 auto-registered). Production seed+verification (created=308, S/N integrity 19/19 PASS, Chrome 7-screen PASS). Full details in Appendix K of the employee manual.
