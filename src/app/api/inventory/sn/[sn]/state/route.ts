    ...
    if (master.archivedAt) {
      ...
      if (master.currentLocationClientId) {
        ...
        recommendations.push(
          ...
          { txnType: "OUT", refModule: "TRADE", subKind: "RETURN", labelKey: "txn.combo.tradeOutReturn", reason: "매입 반품 (공급처에 반환)" },
          { txnType: "OUT", refModule: "TRADE", subKind: "OTHER", labelKey: "txn.combo.tradeOutDispose", reason: "폐기 / 스크랩" },
